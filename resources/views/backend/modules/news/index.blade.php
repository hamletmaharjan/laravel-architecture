                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @if($newsItem->status == 'active')
                                                            <a  class="label label-success stat" href="{{url('admin/news/status',$newsItem->id)}}">
                                                                <strong class="stat"> {{trans('app.active')}}
                                                                </strong>
                                                            </a>

                                                        @elseif($newsItem->status == 'inactive')
                                                            <a class="label label-danger stat" href="{{url('admin/news/status',$newsItem->id)}}">
